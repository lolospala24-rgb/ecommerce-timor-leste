    ...
    const result = await this.prisma.$transaction(async (prisma) => {
      ...
      const seller = await prisma.seller.create({
        data: {
          ...
          storeLogo: registerSellerDto.storeLogo,
          storeBanner: registerSellerDto.storeBanner,
          originMunicipality: registerSellerDto.originMunicipality,
          originPostoAdmin: registerSellerDto.originPostoAdmin,
          originSuco: registerSellerDto.originSuco,
          originAldeia: registerSellerDto.originAldeia,
  ...
  async update(id: number, updateSellerDto: UpdateSellerDto) {
    ...
    const updatedSeller = await this.prisma.seller.update({
      ...
      data: {
        ...
        storeLogo: updateSellerDto.storeLogo,
        storeBanner: updateSellerDto.storeBanner,
        originMunicipality: updateSellerDto.originMunicipality,
        originPostoAdmin: updateSellerDto.originPostoAdmin,
        originSuco: updateSellerDto.originSuco,
        originAldeia: updateSellerDto.originAldeia,
