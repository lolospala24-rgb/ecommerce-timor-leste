...
export const translations: Record<Locale, Dictionary> = {
  tet: {
    ...
    // Deals page
    'deals.title': 'Promosaun & Kupaun',
    'deals.subtitle': 'Kupaun ativu sira neebe ita bele uza bainhira sosa.',
    'deals.empty.title': 'Seidauk iha promosaun ativu',
    'deals.empty.description': 'Fila fali haree iha loron seluk ba oferta foun.',
    'deals.browseProducts': 'Esplora Produtu',
    'deals.copyCode': 'Kopia Kódigu',
    'deals.copied': 'Kódigu kopia ona!',
    'deals.copyFailed': 'La bele kopia kódigu',
    'deals.off': 'diskontu',
    'deals.upTo': 'to\'o',
    'deals.minPurchase': 'Sosa mínimu',

    // Search page
    'search.title': 'Rezultadu Buka',
    'search.placeholder': 'Buka produtu, kategoria, vendedór...',
    'search.filters': 'Filtru',
    'search.clearAllFilters': 'Hamos Filtru Hotu',
    'search.clearFilters': 'Hamos filtru',
    'search.showingResultsFor': 'Hatudu rezultadu ba:',
    'search.resultsCount': 'rezultadu',
    'search.aiUnderstoodAs': 'AI komprende',
    'search.aiUnderstoodSuffix': "nu'udar:",
    'search.anyProduct': 'kualkér produtu',
    'search.category': 'kategoria',
    'search.any': 'kualkér',
    'search.tabs.products': 'Produtu',
    'search.tabs.categories': 'Kategoria',
    'search.tabs.sellers': 'Vendedór',
    'search.noProducts.title': 'Laiha produtu hetan',
    'search.noProducts.description': "Ami la hetan produtu ida ne'ebé kombina ho ita-nia kritériu buka. Favor troka filtru ka liafuan buka.",
    'search.noCategories': "Laiha kategoria hetan ne'ebé kombina ho ita-nia buka",
    'search.noSellers': "Laiha vendedór hetan ne'ebé kombina ho ita-nia buka",
    'search.productsCount': 'produtu',
    'search.verified': 'Verifikadu',

    // Support chat widget
    'support.title': 'Presiza ajuda?',
    'support.close': 'Taka',
    'support.whatsapp': 'Chat liu husi WhatsApp',
    'support.email': 'Haruka email',
    'support.greeting': 'Ola! Hau iha pergunta kona-ba...',
    ...
    'promotion.storeTab': 'Promosaun Loja',
    'promotion.storeSubtitle': 'Produtu promosaun ativu husi loja ida ne\'e.',
  ...
  en: {
    ...
    // Deals page
    'deals.title': 'Deals & Coupons',
    'deals.subtitle': 'Active coupons you can use at checkout.',
    'deals.empty.title': 'No active deals right now',
    'deals.empty.description': 'Check back soon for new offers.',
    'deals.browseProducts': 'Browse Products',
    'deals.copyCode': 'Copy Code',
    'deals.copied': 'Code copied!',
    'deals.copyFailed': 'Could not copy code',
    'deals.off': 'off',
    'deals.upTo': 'up to',
    'deals.minPurchase': 'Minimum spend',

    // Search page
    'search.title': 'Search Results',
    'search.placeholder': 'Search for products, categories, sellers...',
    'search.filters': 'Filters',
    'search.clearAllFilters': 'Clear All Filters',
    'search.clearFilters': 'Clear filters',
    'search.showingResultsFor': 'Showing results for:',
    'search.resultsCount': 'results',
    'search.aiUnderstoodAs': 'AI understood',
    'search.aiUnderstoodSuffix': 'as:',
    'search.anyProduct': 'any product',
    'search.category': 'category',
    'search.any': 'any',
    'search.tabs.products': 'Products',
    'search.tabs.categories': 'Categories',
    'search.tabs.sellers': 'Sellers',
    'search.noProducts.title': 'No products found',
    'search.noProducts.description': "We couldn't find any products matching your search criteria. Try adjusting your filters or search terms.",
    'search.noCategories': 'No categories found matching your search',
    'search.noSellers': 'No sellers found matching your search',
    'search.productsCount': 'products',
    ...
    'support.greeting': 'Hi! I have a question about...',
    ...
    'product.badge.local': 'Local',
    'promotion.storeTab': 'Store Promotions',
    'promotion.storeSubtitle': "This seller's currently active promotional products.",
  ...
  id: {
    ...
    // Deals page
    'deals.title': 'Promo & Kupon',
    'deals.subtitle': 'Kupon aktif yang bisa digunakan saat checkout.',
    'deals.empty.title': 'Belum ada promo aktif',
    'deals.empty.description': 'Cek lagi nanti untuk penawaran baru.',
    'deals.browseProducts': 'Jelajahi Produk',
    'deals.copyCode': 'Salin Kode',
    'deals.copied': 'Kode disalin!',
    'deals.copyFailed': 'Gagal menyalin kode',
    'deals.off': 'diskon',
    'deals.upTo': 'hingga',
    'deals.minPurchase': 'Belanja minimum',

    // Search page
    'search.title': 'Hasil Pencarian',
    'search.placeholder': 'Cari produk, kategori, penjual...',
    'search.filters': 'Filter',
    'search.clearAllFilters': 'Hapus Semua Filter',
    'search.clearFilters': 'Hapus filter',
    'search.showingResultsFor': 'Menampilkan hasil untuk:',
    'search.resultsCount': 'hasil',
    'search.aiUnderstoodAs': 'AI memahami',
    'search.aiUnderstoodSuffix': 'sebagai:',
    'search.anyProduct': 'produk apa saja',
    'search.category': 'kategori',
    'search.any': 'berapa pun',
    'search.tabs.products': 'Produk',
    'search.tabs.categories': 'Kategori',
    'search.tabs.sellers': 'Penjual',
    'search.noProducts.title': 'Produk tidak ditemukan',
    'search.noProducts.description': 'Kami tidak menemukan produk yang sesuai dengan kriteria pencarian Anda. Coba sesuaikan filter atau kata kunci pencarian.',
    'search.noCategories': 'Tidak ada kategori yang cocok dengan pencarian Anda',
    'search.noSellers': 'Tidak ada penjual yang cocok dengan pencarian Anda',
    'search.productsCount': 'produk',
    'search.verified': 'Terverifikasi',

    // Support chat widget
    'support.title': 'Butuh bantuan?',
    'support.close': 'Tutup',
    'support.whatsapp': 'Chat via WhatsApp',
    'support.email': 'Kirim email',
    'support.greeting': 'Halo! Saya punya pertanyaan tentang...',
    ...
    'promotion.storeTab': 'Promo Toko',
    'promotion.storeSubtitle': 'Produk promosi yang sedang aktif dari toko ini.',
  ...
  pt: {
    ...
    // Deals page
    'deals.title': 'Ofertas e Cupons',
    'deals.subtitle': 'Cupons ativos que você pode usar no checkout.',
    'deals.empty.title': 'Nenhuma oferta ativa no momento',
    'deals.empty.description': 'Volte em breve para novas ofertas.',
    'deals.browseProducts': 'Explorar Produtos',
    'deals.copyCode': 'Copiar Código',
    'deals.copied': 'Código copiado!',
    'deals.copyFailed': 'Não foi possível copiar o código',
    'deals.off': 'de desconto',
    'deals.upTo': 'até',
    'deals.minPurchase': 'Compra mínima',

    // Search page
    'search.title': 'Resultados da Busca',
    'search.placeholder': 'Pesquisar produtos, categorias, vendedores...',
    'search.filters': 'Filtros',
    'search.clearAllFilters': 'Limpar Todos os Filtros',
    'search.clearFilters': 'Limpar filtros',
    'search.showingResultsFor': 'A mostrar resultados para:',
    'search.resultsCount': 'resultados',
    'search.aiUnderstoodAs': 'A IA entendeu',
    'search.aiUnderstoodSuffix': 'como:',
    'search.anyProduct': 'qualquer produto',
    'search.category': 'categoria',
    'search.any': 'qualquer',
    'search.tabs.products': 'Produtos',
    'search.tabs.categories': 'Categorias',
    'search.tabs.sellers': 'Vendedores',
    'search.noProducts.title': 'Nenhum produto encontrado',
    'search.noProducts.description': 'Não encontrámos nenhum produto que corresponda aos seus critérios de busca. Tente ajustar os filtros ou os termos de busca.',
    'search.noCategories': 'Nenhuma categoria encontrada correspondente à sua busca',
    'search.noSellers': 'Nenhum vendedor encontrado correspondente à sua busca',
    'search.productsCount': 'produtos',
    'search.verified': 'Verificado',

    // Support chat widget
    'support.title': 'Precisa de ajuda?',
    'support.close': 'Fechar',
    'support.whatsapp': 'Conversar no WhatsApp',
    'support.email': 'Enviar um email',
    'support.greeting': 'Olá! Tenho uma pergunta sobre...',
    ...
    'product.badge.popular': 'Popular',
    'product.badge.local': 'Local',
    'promotion.storeTab': 'Promoções da Loja',
    'promotion.storeSubtitle': 'Produtos em promoção atualmente ativos desta loja.',
